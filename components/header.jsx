...
import "./header.scss"
import { ContextGlobal } from "../src/App";


export default function Header() {


    const {isTokenValid, setIsTokenValid} = useContext(ContextGlobal)
    ...
    useEffect(() => {
        //aqui vemos si el token jwt es valido para poner un icono de perfil
        //aqui hacer fetch
            ...
            <div className="nav-header-content">
                ...
                <div className="nav-right">
                    <div className="lupaIcon-header">
                        <input className="input-element" onKeyUp={keyUpLupa}></input>
...

                    {
                        isTokenValid ?
                            (
                                <div className="logeado_header">
                                    <img src="https://i.redd.it/ib7scrg5t7w61.png">
                                    </img>
                                </div>)
                            :
                            isTokenValid == null ? (
                                <span className="loadingPerfil_header">...</span>)
                                :

                                <div className="icon-right_header">
                                    <div className="icon-login_header" onClick={clickLogin}>
